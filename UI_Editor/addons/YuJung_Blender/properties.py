...
class Size(bpy.types.PropertyGroup):
...
def propertiesRegister():
    bpy.utils.register_class(Size)
    bpy.types.Scene.size = bpy.props.PointerProperty(type = Size)
...
def propertiesUnregister():
    ...
    bpy.utils.unregister_class(Size)
